...
const tryRegister = async () => {
  ...
  const msg = await accountStore.register(email.value, password.value, firstName.value + " " + lastName.value);
  if (msg) {
    notificationStore.pushNotification({
      id: 0,
      duration: 2000,
        ...
        <div id="login-card-body">
          <div id="login-card-body-inputs">
            ...
            <div class="input-group">
              ...
              <input type="text" id="lastName" placeholder="Wick" v-model="lastName"/>
            </div>
            <div class="input-group">
              <label for="password">
              ...
              <input type="password" id="password" placeholder="D0n!TouChMyD0G" v-model="password"/>
            </div>
            <div class="input-group">
              <label for="password">
                <i class="fas fa-lock"></i>
              ...
              <input type="password" id="password" placeholder="D0n!TouChMyD0G" v-model="passwordConfirmation" @keyup.enter="tryRegister" />
            </div>
          </div>
          <div id="login-card-body-actions">
            <button id="login-card-body-actions-login" @click="tryRegister">Sign Up</button>
          </div>
          <div id="login-card-body-subactions">
            <span>Already have an account?</span>
            <button id="login-card-body-subactions-login" @click="navigateTo('/auth/login')">Login</button>
          </div>
        </div>
      </div>
    </div>
